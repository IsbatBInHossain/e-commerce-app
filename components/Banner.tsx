...
const Banner = () => {
  return (
    <div
      className='bg-cover h-[340px] w-full py-10 px-16 flex justify-between items-start relative'
    ...
    >
      <div className=' p-6 flex flex-col max-w-[490px]'>
        ...
        <div className=' text-sm capitalize max-w-[390px] mt-2'>
          <p>
      ...
      <div className=' w-40 h-40 bg-gradient-to-r from-[#FDC830] to-[#F37335] rounded-full p-8 text-center'>
        <h2 className=' text-white text-5xl font-light'>40% Off</h2>
      </div>
    </div>
  )
}
